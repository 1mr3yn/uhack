...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><b class='text-yellow'>G</b><b class='text-primary'>lend</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b class='text-yellow'>G</b><b class='text-primary'>lend</b></span>
    </a>
